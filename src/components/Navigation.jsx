    ...
    return (
        <>
            <div ref={first} className='icon w-full bg-[#00925B] min-h-[280px] absolute top-[-500px] z-50'>
                <img onClick={() => closeMenuIcon()} className='w-7 py-2 absolute right-2' src="public/closeIcon.png" />
            ...
            <div className='text-white flex items-center justify-between px-7 py-2 h-[100px]'>
                <img className='md:w-[150px] w-[120px]' src="public/logo.svg" />
                ...
                <img onClick={() => openMenuIcon()} className='md:hidden block md:w-[3rem] w-[2rem] cursor-pointer' src="public/menuIcon.png" />
            </div>
        </>
    )
}
