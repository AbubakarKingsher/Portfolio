    ...
    return (
        <>
            ...
            <div className='text-white flex items-center justify-between px-7 py-2 h-[100px]'>
                <img className='md:w-[150px] w-[120px]' src="./src/assets/logo.svg" />
                ...
                <img onClick={() => openMenuIcon()} className='md:hidden block md:w-[3rem] w-[2rem] cursor-pointer' src="./src/assets/menuIcon.png" />
            </div>
        </>
    )
}
