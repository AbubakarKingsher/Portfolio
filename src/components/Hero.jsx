...
function Hero() {
    ...
    return (
        <div className='min-h-[100vh] w-full flex md:items-center justify-between overflow-hidden flex-col md:flex-row'>
            <div className='pl-[10vw] pt-[10vw] md:pt-[0]'>
                ...
                <a href="https://wa.me/923312839822?text=" target="_parent">
                    <button className='py-3 px-7 outline-none mt-7 bg-[#029D66] flex items-center gap-3 rounded-sm text-base font-medium'>Contact me <img className='w-6' src="/assets/contactIcon.png" /></button>
                </a>
            </div>
            <img className='md:w-[25vw] w-[50vw] mx-auto md:mx-0 pt-10 md:pt-0' src="/assets/heroSecPic.webp" />
        </div>
    )
}
